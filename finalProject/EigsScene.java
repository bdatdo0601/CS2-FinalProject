...
public class EigsScene {
	...
	public static Scene eigsScene(Stage primaryStage) {
		...
		gp.getChildren().addAll(btHome, l_sceneTitle, l_instruction, l_result, inputBox, parseBt, parseOut, l_eigValues,
				l_eigVectors, eigValBt, eigVecBt, eigVecOut, eigValOut);
