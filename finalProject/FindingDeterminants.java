...
//One of the methods used for final project 

import java.util.Scanner;

public class FindingDeterminants {
	...
	public static double determinant(double M[][], int dim) {
		...
		if (dim == 1) {
			...
			for (int j1 = 0; j1 < dim; j1++) {
				...
				for (int i = 1; i < dim; i++) // because the first row is always
												// expanded upon in my algorithm
				{
					int j2 = 0;
