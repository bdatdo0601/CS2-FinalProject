...
public class MultiplyMatrices 
{
	...
	public static void main(String[] args) 
	{
	    ...
	    double[][] result = multiply(A, B); //special method to multiply the 2 matrices
	...
	public static double[][] multiply(double[][] a, double[][] b) 
	{
		...
		double[][] C = new double[rowsInA][columnsInB]; //stores results in new matrix (dimensions = outer dimensions of A * B)
		...
		for (int r = 0; r < rowsInA; r++) 
		{
			...
			for (int c = 0; c < columnsInB; c++) 
			{
	               ...
	               {
	                   C[r][c] = C[r][c] + a[r][k] * b[k][c]; //C[row][col] = row of A * col of B 
	               }
	           }
	       }
